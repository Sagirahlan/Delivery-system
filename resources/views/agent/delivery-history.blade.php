                ...
                <div class="d-flex align-items-center">
                    <div class="symbol symbol-40px me-3">
                        <div class="symbol-label bg-light-primary d-flex align-items-center justify-content-center">
                            <i class="ki-duotone ki-wallet fs-4 text-primary"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                        </div>
                    </div>
                    <div>
                        <div class="text-muted fs-7 fw-semibold">Total Revenue</div>
                        <div class="fs-4 fw-bolder text-primary font-monospace">₦{{ number_format($stats['total_revenue'], 2) }}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="card card-flush mb-6">
    <div class="card-header py-4">
        <h3 class="card-title fw-bolder text-dark fs-4">
            <i class="ki-duotone ki-filter fs-4 me-2"><span class="path1"></span><span class="path2"></span></i>
            Filters
        </h3>
    </div>
    <div class="card-body">
...
<div class="card card-flush">
    <div class="card-header d-flex justify-content-between align-items-center py-4">
        <h3 class="card-title fw-bolder text-dark fs-4">
            ORDERS
            <span class="badge badge-light-primary ms-2">{{ $orders->total() }}</span>
        </h3>
        <a href="{{ route('orders.place') }}" class="btn btn-primary btn-sm">
