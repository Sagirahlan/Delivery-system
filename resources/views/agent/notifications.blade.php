        ...
        <div class="card card-flush">
            <div class="card-header d-flex justify-content-between align-items-center py-4">
                <h3 class="card-title fw-bolder text-dark fs-4">
                    <i class="ki-duotone ki-notification-1 fs-4 me-2"><span class="path1"></span><span class="path2"></span></i>
                    All Notifications
                </h3>
                @if($unreadCount > 0)
                <button class="btn btn-sm btn-light-primary" id="mark-all-read">
                    <i class="ki-duotone ki-check-double fs-4 me-1"><span class="path1"></span><span class="path2"></span></i>
                    Mark All Read
                </button>
                @endif
            </div>
    ...
    <div class="col-lg-4">
        <div class="card card-flush">
            <div class="card-header py-4">
                <h3 class="card-title fw-bolder text-dark">QUICK STATS</h3>
            </div>
            <div class="card-body">
